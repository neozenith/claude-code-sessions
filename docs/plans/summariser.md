...
| [CR4](./summariser-CR4.md) | Located, gaming-resistant scorecard — compression ratio + lead/oracle anchors + embedding cosine + LLM-as-judge | [CR1](./summariser-CR1.md) (bare lexical triple is uninterpretable) | proposed (2026-06-01) — analysis in [summariser-SCORING.md](./summariser-SCORING.md); answers "good vs great" by anchoring the spectrum |
