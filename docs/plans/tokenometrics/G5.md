...
> - **Architecture:** [G5 increment](./DISCOVERY.md#g5-increment)
> - **Depends on:** [G4](./G4.md)
...
|--------|----------|------------|
| [T5.1](./G5-T5.1.md) | An operator sees idle time between assistant stop and next prompt | [T4.1](./G4-T4.1.md) |
| [T5.2](./G5-T5.2.md) | An operator sees active (working) time per turn | [T5.1](./G5-T5.1.md) |
| [T5.3](./G5-T5.3.md) | A reviewer sees a 'too-fast' flag only for implausibly quick replies | [T5.1](./G5-T5.1.md) |
| [T5.4](./G5-T5.4.md) | Machine latency is not counted as human idle | [T5.1](./G5-T5.1.md) |
