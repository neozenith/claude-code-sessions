...
> - **Architecture:** [G3 increment](./DISCOVERY.md#g3-increment)
> - **Depends on:** [G1](./G1.md)
...
|--------|----------|------------|
| [T3.1](./G3-T3.1.md) | A caller gets a subagent-prefixed kind for subagent events | — |
| [T3.2](./G3-T3.2.md) | An operator sees no bare 'human' kinds in subagent transcripts | [T1.1](./G1-T1.1.md), [T3.1](./G3-T3.1.md) |
| [T3.3](./G3-T3.3.md) | Main-thread human prompts remain unprefixed | [T3.2](./G3-T3.2.md) |
