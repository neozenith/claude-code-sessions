...
> - **Architecture:** [G2 increment](./DISCOVERY.md#g2-increment)
> - **Depends on:** [G1](./G1.md)
> - **Blocks:** [G6](./G6.md), [G8](./G8.md)
> - **Prev:** [G1](./G1.md)
> - **Next:** [G3](./G3.md)
...
|--------|----------|------------|
| [T2.1](./G2-T2.1.md) | A caller can resolve a 1M-window model's context window | — |
| [T2.2](./G2-T2.2.md) | A caller gets 200k for standard models and None for unknown | [T2.1](./G2-T2.1.md) |
| [T2.3](./G2-T2.3.md) | Window lookup is not fooled by substring collisions | [T2.1](./G2-T2.1.md) |
| [T2.4](./G2-T2.4.md) | A caller gets the context-utilization ratio (fraction of window used) | [T2.1](./G2-T2.1.md) |
| [T2.5](./G2-T2.5.md) | ~~The absolute-token override supersedes percentage on 1M windows~~ **Dropped** (zone labeling removed per ADR) | [T2.4](./G2-T2.4.md) |
| [T2.6](./G2-T2.6.md) | An operator sees per-event occupancy and ratio after ingestion | [T1.1](./G1-T1.1.md), [T2.1](./G2-T2.1.md) |
