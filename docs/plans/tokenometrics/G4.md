...
> - **Architecture:** [G4 increment](./DISCOVERY.md#g4-increment)
> - **Depends on:** [G1](./G1.md)
> - **Blocks:** [G5](./G5.md), [G8](./G8.md)
> - **Prev:** [G3](./G3.md)
> - **Next:** [G5](./G5.md)
...
|--------|----------|------------|
| [T4.1](./G4-T4.1.md) | An operator sees a response's tokens/sec | [T1.1](./G1-T1.1.md) |
| [T4.2](./G4-T4.2.md) | TPS is absent when duration is unknown | [T4.1](./G4-T4.1.md) |
