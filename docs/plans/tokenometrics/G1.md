...
> - **Depends on:** none
> - **Blocks:** [G2](./G2.md), [G3](./G3.md), [G4](./G4.md), [G6](./G6.md), [G8](./G8.md)
> - **Next:** [G2](./G2.md)
...
|--------|----------|------------|
| [T1.1](./G1-T1.1.md) | An operator can see a multi-block response counted once in session totals | — |
| [T1.2](./G1-T1.2.md) | An operator can see exactly one response-head per requestId | [T1.1](./G1-T1.1.md) |
| [T1.3](./G1-T1.3.md) | A single-block response is its own head with usage intact | [T1.1](./G1-T1.1.md) |
| [T1.4](./G1-T1.4.md) | A synthetic assistant event (no requestId) is its own head | [T1.1](./G1-T1.1.md) |
